...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->group(['middleware' => 'auth'], function () use ($router) {
        ...
        $router->patch('/board/update/{id}', 'BoardController@update');//am folosit patch pt ca are un set de instructiuni pt a modifica 
        //resursa ,ca sa produca o versiune noua , in timp ce cu put resursa modificata trebuie practic inlocuita
