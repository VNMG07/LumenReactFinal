...
//Pun valoarea tokenului meu de acces in localstorage,fac un request catre ruta de boards
//apoi pun in header autorizarea 
          ...
          switch (error.response.status) {
            case 400:
              errorsRef.current.innerHTML =
                error.response.data.errorMessages.name === undefined && error.response.data.errorMessages.id !== undefined
                  ? error.response.data.errorMessages.id : error.response.data.errorMessages.name !== undefined &&
                    error.response.data.errorMessages.id === undefined ? error.response.data.errorMessages.name
                  : error.response.data.errorMessages.name !== undefined && error.response.data.errorMessages.id !== undefined
                  ? error.response.data.errorMessages.name + " / " + error.response.data.errorMessages.id : "";
              default:
                break;
          }
        }
