          ...
          switch (error.response.status) {
            case 400:
              errorsRef.current.innerHTML =
                ...
                error.response.data.errorMessages.password === undefined ? error.response.data.errorMessages.email
                  : error.response.data.errorMessages.password !== undefined && error.response.data.errorMessages.email === undefined
                  ? error.response.data.errorMessages.password : error.response.data.errorMessages.email !== undefined &&
                    error.response.data.errorMessages.password !== undefined ? error.response.data.errorMessages.email +
